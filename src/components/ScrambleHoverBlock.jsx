...
function ScrambleHoverBlock() {
  ...
  const updateCharData = () => {
    ...
    setTimeout(() => {
      const split = new SplitText(blockRef.current, {
        type: "chars",
        charsClass: "char",
      });
  ...
  return (
    <div className={`scramble-wrapper ${ready ? "visible" : ""}`}>
      <p ref={blockRef}>
        ...
        Wexford, Ireland. My work combines photography, videography, voice work,
        and honest storytelling to create content that resonates with a global
        audience. Drawing inspiration from the natural beauty of Wexford and my
        life experiences, I create content focused on personal growth, mental
        health, and resilience. My two dogs, Ashah and Rebel, a Weimaraner and a
        German Shepherd, often accompany me on creative shoots and are part of
        the creative process that keeps my work grounded and personal. I love
        you awlays! JD x
      </p>
    </div>
  );
